---
name: prompt-caching
description: Caching strategies for LLM prompts including Anthropic prompt caching, response caching, KV-cache management, and Cache Augmented Generation (CAG).
---
