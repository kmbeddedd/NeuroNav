...
This directory provides tools, scripts, and verified sources to obtain, download, and generate clean, authentic **GNSS (GPS, GLONASS, Galileo, BeiDou) and NavIC (IRNSS)** satellite clock and orbit (ephemeris) error datasets for machine learning forecasting.
...
1. **OrbitIQ GNSS Ephemeris Benchmark**:
   - Contains the 7-day baseline datasets and evaluation configurations for GEO and MEO satellites.
