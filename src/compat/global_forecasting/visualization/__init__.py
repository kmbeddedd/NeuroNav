from src.compat.global_forecasting.visualization.forecast import plot_forecast_components, plot_3d_orbit_error
from src.compat.global_forecasting.visualization.scientific import (
    plot_residual_qq,
